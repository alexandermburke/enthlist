        ...
        <div className='fixed top-0 left-0 h-screen w-screen z-[1000] flex justify-center items-center'>
            ...
            <div className='relative flex justify-center items-center w-full h-full'>
                <button
                    ...
                    className='absolute left-4 top-1/2 transform -translate-y-1/2 bg-gray-600 text-white px-3 py-2 rounded-full opacity-75 hover:opacity-100 z-10'
                >
                    &lt;
                </button>
                ...
                <button
                    ...
                    className='absolute right-4 top-1/2 transform -translate-y-1/2 bg-gray-600 text-white px-3 py-2 rounded-full opacity-75 hover:opacity-100 z-10'
                >
                    &gt;
                </button>
                <button
